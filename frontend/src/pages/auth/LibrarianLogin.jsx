      ...
      <div style={styles.card}>
        ...
        <div style={styles.leftPanel}>
          <div style={styles.formContainer}>
            ...
            <p style={styles.subtitle}>Enter your staff credentials</p>
        ...
        <div style={styles.rightPanel}>
          ...
          <div style={styles.rightContent}>
            <h1 style={styles.rightTitle}>Welcome to<br/>librarian portal</h1>
            <p style={styles.rightSubtitle}>Login to manage library records</p>
            
            <div style={styles.imgWrapper}>
              <img src="/purple-student-illustration.png" alt="Librarian Illustration" style={styles.illustration} />
            </div>
          </div>
        </div>
