      ...
      <div style={styles.card}>
        ...
        <div style={styles.leftPanel}>
          <div style={styles.formContainer}>
            ...
            <p style={styles.subtitle}>Enter your administrator credentials</p>
        ...
        <div style={styles.rightPanel}>
          ...
          <div style={styles.rightContent}>
            <h1 style={styles.rightTitle}>Welcome to<br/>admin portal</h1>
            <p style={styles.rightSubtitle}>Full system control and configuration</p>
            
            <div style={styles.imgWrapper}>
              <img src="/purple-student-illustration.png" alt="Admin Illustration" style={styles.illustration} />
            </div>
          </div>
        </div>
