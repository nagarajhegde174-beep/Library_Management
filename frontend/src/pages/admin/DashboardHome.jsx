...
export default function DashboardHome() {
  ...
  const barOptions = {
    ...
    scales: {
      x: { grid: { display: false }, ticks: { color: tc.tick, font: { size: 10 } } },
      y: { grid: { color: tc.grid }, ticks: { color: tc.tick, font: { size: 10 } }, min: 0 }
    }
  };
  ...
  const lineOptions = {
    ...
    scales: {
      ...
      y: { grid: { color: tc.grid }, ticks: { color: tc.tick }, min: 0 }
    }
  };
